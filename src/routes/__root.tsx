...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Gul & Grace" },
      { property: "og:title", content: "Gul & Grace | Handmade Resin Art & Preserved Flower Keepsakes in Pakistan" },
      {
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Gul & Grace",
          description:
            "Premium handmade resin art and memory preservation brand in Pakistan.",
          slogan: "Preserving Memories. Crafting Elegance.",
          areaServed: "Pakistan",
        }),
      },
    ],
