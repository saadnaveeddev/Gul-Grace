      ...
      <div className="container-luxe py-14">
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div className="space-y-4">
            <a href={waLink("Hello Gul & Grace!")} target="_blank" rel="noreferrer" className="flex items-center gap-4 resin-card rounded-[1.5rem] p-5 resin-card-hover">
              <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-secondary/80"><MessageCircle className="h-5 w-5 text-primary" /></span>
              <span>
                <span className="block font-medium">WhatsApp</span>
                <span className="text-sm text-muted-foreground">Fastest way to reach us — orders & consultations</span>
              </span>
            </a>
            <a href={SOCIALS.instagram} target="_blank" rel="noreferrer" className="flex items-center gap-4 resin-card rounded-[1.5rem] p-5 resin-card-hover">
              <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-secondary/80"><Instagram className="h-5 w-5 text-primary" /></span>
              <span>
            ...
            <a href={SOCIALS.tiktok} target="_blank" rel="noreferrer" className="flex items-center gap-4 resin-card rounded-[1.5rem] p-5 resin-card-hover">
              <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-secondary/80 text-sm font-semibold text-primary">TT</span>
              <span>
            ...
            <div className="flex items-center gap-4 resin-card rounded-[1.5rem] p-5">
              <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-secondary/80"><Mail className="h-5 w-5 text-primary" /></span>
              <span>
            ...
            <div className="flex items-center gap-4 resin-card rounded-[1.5rem] p-5">
              <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-secondary/80"><MapPin className="h-5 w-5 text-primary" /></span>
              <span>
            ...
            <div className="resin-card rounded-[1.5rem] p-6">
              <p className="eyebrow mb-3">Quick Answers</p>
              <ul className="space-y-2 text-sm">
                <li><Link to="/wedding-preservation" className="text-primary underline-offset-4 hover:underline transition-colors">How do I send my wedding flowers? →</Link></li>
                <li><Link to="/custom-order" className="text-primary underline-offset-4 hover:underline transition-colors">How do custom orders work? →</Link></li>
                <li><Link to="/shop" className="text-primary underline-offset-4 hover:underline transition-colors">What can I order right now? →</Link></li>
              </ul>
            </div>
          </div>
        </div>
